...
shortcut search stories --query "owner:ynazarenko is:started" --detail slim
shortcut search stories --query "label:\"ios\" updated:2026-03-01..2026-03-20" --detail slim
shortcut api search search-stories --query "owner:ynazarenko" --detail slim --page_size 5 --output json
```
...
shortcut search stories --limit 5 --query "owner:ynazarenko is:started"
```
