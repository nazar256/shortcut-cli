...
func searchLongDescription(meta shortcutopenapi.CommandMetadata) string {
	...
	parts = append(parts, "Use a member's mention name for `owner:` and `requester:` (for example `owner:ynazarenko`), not `@name` and not `owner:me`.")
